...
//	//设置项目指示器策略。该策略决定何时显示树杈展开/折叠指示器
//	//即使没有子项，也会显示该项目的展开和折叠控件
...
//
//	int nEmployeeNum = 50;
//	QString gsGroupName = QString::fromLocal8Bit("公司群 %1/%2").arg(0).arg(nEmployeeNum);
...
//
//	int nEmployeeNum = 5;
//	QString gsGroupName = QString::fromLocal8Bit("人事部 %1/%2").arg(0).arg(nEmployeeNum);
//	pItemName->setText(gsGroupName);
//
//	ui.treeWidget->addTopLevelItem(pRootItem);
//	ui.treeWidget->setItemWidget(pRootItem, 0, pItemName);
...
//
//	int nEmployeeNum = 8;
//	QString gsGroupName = QString::fromLocal8Bit("市场部 %1/%2").arg(0).arg(nEmployeeNum);
//	pItemName->setText(gsGroupName);
//
//	ui.treeWidget->addTopLevelItem(pRootItem);
//	ui.treeWidget->setItemWidget(pRootItem, 0, pItemName);
...
//
//	int nEmployeeNum = 8;
//	QString gsGroupName = QString::fromLocal8Bit("研发部 %1/%2").arg(0).arg(nEmployeeNum);
//	pItemName->setText(gsGroupName);
//
//	ui.treeWidget->addTopLevelItem(pRootItem);
//	ui.treeWidget->setItemWidget(pRootItem, 0, pItemName);
...
{
	if (ui.textEdit->toPlainText().isEmpty())//转换成纯文本形式
	{
