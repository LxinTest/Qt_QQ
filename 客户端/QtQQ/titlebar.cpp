...
void TitleBar::initControl()
{
	...
	//设置布局
	QHBoxLayout *mylayout = new QHBoxLayout(this);//没有指定父窗口，添加控件的时候，停留在原地了
...
void TitleBar::paintEvent(QPaintEvent *event)
{
	...
	pathBack.addRoundRect(QRect(0, 0, width(), height()), 3, 3);//添加圆角矩形到绘图路径
	painter.setRenderHint(QPainter::SmoothPixmapTransform, true);

	//当窗口最大化或还原后,窗口长度改变,标题栏效应作出改变
	//parentWidget()返回父部件
