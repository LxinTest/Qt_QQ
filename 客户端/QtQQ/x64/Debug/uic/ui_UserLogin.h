...
public:
    ...
    void setupUi(QWidget *UserLogin)
    {
        ...
        editUserAccout = new QLineEdit(bodyWidget);
        editUserAccout->setObjectName(QStringLiteral("editUserAccout"));
        editUserAccout->setMinimumSize(QSize(260, 26));
        editUserAccout->setMaximumSize(QSize(260, 26));
        editUserAccout->setMaxLength(33);

        horizontalLayout->addWidget(editUserAccout);
    ...
    void retranslateUi(QWidget *UserLogin)
    {
        ...
        editUserAccout->setPlaceholderText(QApplication::translate("UserLogin", "\350\257\267\350\276\223\345\205\245\350\264\246\345\217\267", Q_NULLPTR));
