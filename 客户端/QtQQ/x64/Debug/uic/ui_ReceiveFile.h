...
public:
    ...
    void setupUi(QWidget *ReceiveFile)
    {
        ...
        okBtn->setGeometry(QRect(260, 70, 93, 28));
        cancelBtn = new QPushButton(bodyWidget);
        cancelBtn->setObjectName(QStringLiteral("cancelBtn"));
        cancelBtn->setGeometry(QRect(370, 70, 93, 28));
    ...
    {
        ReceiveFile->setWindowTitle(QApplication::translate("ReceiveFile", "ReceiveFile", Q_NULLPTR));
