...
public:
    ...
    void setupUi(QDialog *QtQQ_ServerClass)
    {
        ...
        label->setPixmap(QPixmap(QString::fromUtf8("qiniu.jpg")));
        ...
        headLabel->setGeometry(QRect(170, 80, 72, 51));
